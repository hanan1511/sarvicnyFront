...
export const customersGrid = [
  ...
  {
    headerText: 'Accept',
    template: `<button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded" onclick="acceptClick()">Accept</button>`,
    width: 150,
    textAlign: "Center",
  },
  {
    headerText: 'reject',
    template: `<button class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" onclick="rejectClick()">Reject</button>`,
    width: 150,
    textAlign: "Center",
  }
];
